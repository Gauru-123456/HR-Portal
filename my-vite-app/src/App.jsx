  ...
  return (
       ...
       <Routes>
        ...
        > 
          ...
          <Route path="/employee-dashboard/attendance/:id" element={<Attendance />}></Route>
...
/*PS F:\Simplilearn Journey\PROJECT 4\my-vite-app> Set-ExecutionPolicy -Scope Process -ExecutionPolicy Bypass
PS F:\Simplilearn Journey\PROJECT 4\my-vite-app> npx tailwindcss init -p

tailwind.config.js already exists.
postcss.config.js already exists.
PS F:\Simplilearn Journey\PROJECT 4\my-vite-app> */

//cd "F:\Simplilearn Journey\PROJECT 4\my-vite-app"
